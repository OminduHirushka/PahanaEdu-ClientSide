  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (result) {
        ...
        navigate(`/manager/books/${encodeURIComponent(bookData.name)}`);
      }
    } catch (error) {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#f5f5f5" }}>
        ...
        >
          ...
          <Button type="primary" onClick={() => navigate("/manager/books")}>
            Back to Books
          </Button>
        </div>
      </div>
...
export default ManagerBookUpdate;
